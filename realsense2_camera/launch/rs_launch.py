...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module_profile',         'default': '0,0,0', 'description': 'depth module profile'},                           
                           {'name': 'enable_depth',                 'default': 'true', 'description': 'enable depth stream'},
                           {'name': 'rgb_camera_profile',           'default': '0,0,0', 'description': 'color image width'},
                           ...
                           {'name': 'pointcloud_enable',            'default': 'false', 'description': ''}, 
                           {'name': 'pointcloud.stream_filter',     'default': '2', 'description': 'texture stream for pointcloud'},
                           {'name': 'pointcloud.stream_index_filter','default': '0', 'description': 'texture stream index for pointcloud'},
                           {'name': 'enable_sync',                  'default': 'false', 'description': "''"},                           
                           {'name': 'align_depth_enable',           'default': 'false', 'description': "''"},                           
                           {'name': 'colorizer_enable',             'default': 'false', 'description': "''"},
                           ...
                           {'name': 'decimation_filter_enable',     'default': 'false', 'description': 'Rate of publishing static_tf'},
                           ...
                           {'name': 'hdr_merge_enable',             'default': 'false', 'description': 'hdr_merge filter enablement flag'},
